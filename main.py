"""Generated Forge lite application for QuickCredit — Personal Loan Automated Underwriting (QPLAU).
...
app = FastAPI(title="QuickCredit — Personal Loan Automated Underwriting", version="1.0.0")
