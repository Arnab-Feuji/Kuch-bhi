...
BUILD_SPEC: dict[str, Any] = {
  ...
  "requirement_text": "Organisation: Apollo Hospitals\nSegment: Healthcare — Patient Engagement\n\nAI SUGGESTED & EDITED PARAMETERS:\nTOOLS AND TECH STACKS: Python, Node.js, TensorFlow, React, MongoDB, AWS for cloud infrastructure\nKNOWLEDGE BASE SOURCES: Clinical guidelines, Patient FAQs, Internal knowledge base, Latest medical research articles\nSUPPORTED LANGUAGES: English, Hindi, Tamil, Telugu\nPERSONA AND TONE: Empathetic, informative, patient-centric, and supportive\nFALLBACK MECHANISMS: Human escalation, emergency service call option, alternative communication methods for non-responsive interactions\nLLM FOUNDATION MODEL: GPT-4, Dialogflow, custom-trained medical AI models\nEXPECTED OUTCOME: 40% reduction in call center volume, patient satisfaction above 4.2/5, zero clinical safety incidents, improved response time for non-emergency inquiries\nREGULATORY CONSTRAINTS: HIPAA compliance, no diagnostic claims, logging for clinical audit, adherence to local telehealth regulations\nINTEGRATION WITH EXISTING SYSTEMS: Seamless integration with the existing hospital appointment system for real-time slot booking and patient record access\n",
  ...
  "input_fields": [
    ...
    {
      "name": "AWS_for_cloud_infrastructure",
      "dtype": "float",
      "description": ""
    }
  ],
  "sample_input": {
    ...
    "React": 1.0,
    "MongoDB": 1.0,
    "AWS_for_cloud_infrastructure": 1.0
  },
  "output_fields": [],
  "rag_sources": [
    "CDC",
